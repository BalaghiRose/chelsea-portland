...
import { caseStudies, featuredCaseStudies, getCaseStudyHref } from "../utils/components/caseStudies";
...
export default function CaseStudiesPage() {
  const spotlight = featuredCaseStudies[0];
  const secondaryStudies = caseStudies.filter((study) => study.id !== spotlight?.id);
      ...
      <section className="relative overflow-hidden bg-[#08131d] pt-32 pb-20 text-white lg:pt-40 lg:pb-28">
        ...
        <div className="relative mx-auto grid max-w-[1500px] gap-12 px-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-end lg:px-10">
          <div className="max-w-[760px]">
            ...
            <p className="section-label mx-auto text-secondary lg:mx-0">Case Studies</p>
          ...
          <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
            {[
              ...
              { value: "04", label: "Featured on homepage" },
        ...
        <div className="mx-auto max-w-[1500px] px-6 lg:px-10">
          ...
          <div className="grid gap-8 lg:grid-cols-2 mt-20">
            {secondaryStudies.map((study, index) => (
              <CaseStudyShowcaseCard key={study.id} study={study} index={index} />
            ))}
          </div>
        </div>
      </section>
