...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-heading section-subheading leading-none font-medium",
        className
      )}
      {...props}
    />
